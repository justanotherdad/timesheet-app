...
import TimesheetOptionsManager from '@/components/admin/TimesheetOptionsManager'

export const dynamic = 'force-dynamic'

export default async function TimesheetOptionsAdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Header
        title={readOnly ? 'View Timesheet Options' : 'Manage Timesheet Options'}
        showBack
        backUrl="/dashboard"
        user={user}
      />
